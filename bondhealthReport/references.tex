...
\bibitem{bcryptbest}
OWASP Foundation. (2024). \textit{Password Storage Cheat Sheet}. Retrieved from \url{https://cheatsheetseries.owasp.org/cheatsheets/Password_Storage_Cheat_Sheet.html}
...
\bibitem{indiahealth}
Ministry of Health and Family Welfare. (2023). \textit{National Digital Health Blueprint}. Government of India. Retrieved from \url{https://main.mohfw.gov.in/sites/default/files/Final\%20NDHB\%20report_0.pdf}
...
OWASP Foundation. (2024). \textit{SQL Injection Prevention Cheat Sheet}. Retrieved from \url{https://cheatsheetseries.owasp.org/cheatsheets/SQL_Injection_Prevention_Cheat_Sheet.html}

% Cross-Site Scripting Prevention
\bibitem{xss}
OWASP Foundation. (2024). \textit{XSS Prevention Cheat Sheet}. Retrieved from \url{https://cheatsheetseries.owasp.org/cheatsheets/Cross_Site_Scripting_Prevention_Cheat_Sheet.html}
