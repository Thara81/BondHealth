...
// The complete HTML content as a template string
const HTML_TEMPLATE = `
<!doctype html>
<html lang="en">
 <head>
  ...
  <style>
    * {
    ...
    .particle-3 {
      ...
      top: 50%;
      left: 5%;
      animation: drift 22s ease-in-out infinite 1s;
    }
    ...
    .particle-5 {
      ...
      top: 70%;
      left: 80%;
      animation: drift 24s ease-in-out infinite 1.5s;
    }
    ...
    .particle-6 {
      ...
      top: 30%;
      left: 50%;
      animation: drift 26s ease-in-out infinite 2.5s;
    }
    ...
    .particle-7 {
      ...
      bottom: 25%;
      left: 30%;
      animation: drift 23s ease-in-out infinite 0.8s;
    }
    ...
    .particle-8 {
      ...
      top: 60%;
      right: 5%;
      animation: drift 27s ease-in-out infinite 2.2s;
    }
    ...
    .success-message.show {
      display: block;
      animation: slideDown 0.4s cubic-bezier(0.34, 1.56, 0.64, 1), pulse 2s ease-in-out 0.4s;
    }
    ...
    @keyframes pulse {
      0%, 100% {
        box-shadow: 0 0 0 0 rgba(21, 87, 36, 0.3);
      }
      50% {
        box-shadow: 0 0 0 8px rgba(21, 87, 36, 0);
      }
    }
    ...
    .dropdown-menu.show {
      display: block;
      animation: dropdownSlide 0.5s cubic-bezier(0.34, 1.56, 0.64, 1);
    }
 ...
 <body>
    ...
    <div class="signin-container">
     <div class="form-content">
      <div class="logo-section">
       ...
       <div class="website-name" id="websiteName">Bond Health</div>
       <div class="tagline">Secure Sign In</div>
      </div>
      <div class="toggle-section">
       <button class="toggle-btn active" data-type="patient" id="patientBtn">
        <span id="patientLabel">Patient</span>
       </button>
       <button class="toggle-btn" data-type="hospital" id="hospitalBtn">
        <span id="hospitalLabel">Hospital</span>
       </button>
      </div>
      ...
      <form class="form-section" id="patientForm">
       ...
       <a href="#" class="forgot-pw-link" id="forgotPwLink">
        <span id="forgotPwText">Forgot password?</span>
       </a>
       ...
       <div class="signup-section">
        <div class="signup-text">
         <span id="signUpPrompt">Don't have an account?</span>
         <a href="#" class="signup-link" id="signUpLink">
          <span>Sign up</span>
         </a>
        </div>
       </div>
      ...
      <form class="form-section" id="hospitalForm" style="display: none;">
       ...
       <button type="submit" class="signin-btn">
        <span id="signInButtonText2">Sign In</span>
       </button>
       <div class="signup-section">
        <div class="signup-text">
         <a href="#" class="signup-link" id="signUpLink2">
  ...
  <script>
    ...
    document.getElementById('signUpLink2').addEventListener('click', function(e) {
      e.preventDefault();
      showMessage('Redirecting to hospital registration...');
    });
...
const server = http.createServer((req, res) => {
    if (req.url === '/' || req.url === '/index.html') {
        ...
        // Handle API endpoints if needed
...
server.listen(PORT, () => {
    ...
    console.log(`   📁 Single file: server.js`);
